...
public class Simulation {
    public static void main(String[] args) {
        ...
        /* BASIC TESTING */
        int nrSellers = 10; //Orig : 50
        int nrBidders = 10; //Orig : 20
        ...
        int itemIDSize = server.getSubmittedItems().size();
        ...
        for( Bidder b : bidders){
            cashSpent = cashSpent + b.cashSpent();
        }

        System.out.println("\nActual sold count (based on arr size) -> " + soldItemsRecorded );
        System.out.println("Sold itmes recorded (soldItems count) -> " + soldItems + "\n");
        System.out.println("Revenue obtained from summing arr -> " + revenueRecorded );
        System.out.println("Cash spent by all bidders combined -> " + cashSpent );
        System.out.println("Revenue recorded (revenue sum) -> " + revenue + "\n");
        System.out.println("No of items submitted -> " + itemIDSize);
        System.out.println("SubmitCount recorded -> " + count + "\n");
